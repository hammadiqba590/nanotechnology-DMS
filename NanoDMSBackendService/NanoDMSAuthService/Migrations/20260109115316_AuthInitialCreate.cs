        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PcName = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    LoginDateTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Audit_Login", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaritalStatus = table.Column<Guid>(type: "uuid", nullable: false),
                    BloodGroup = table.Column<string>(type: "text", nullable: false),
                    AlternateNumber = table.Column<string>(type: "text", nullable: false),
                    EmergencyContact = table.Column<string>(type: "text", nullable: false),
                    NTNNumber = table.Column<string>(type: "text", nullable: false),
                    ...
                    SmsAlert = table.Column<bool>(type: "boolean", nullable: false),
